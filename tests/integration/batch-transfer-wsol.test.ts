...
describe("Batch Transfer Operations - wSOL Tests", () => {
  ...
  it("should execute batch transfer with wSOL", async () => {
    ...
    try {
      ...
      recordGasUsage("ptf_pool", "execute_batch_transfer", computeUnits);
